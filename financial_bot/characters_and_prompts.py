...
התחל את הפוסט תמיד עם הכותרת בפורמט הבא בדיוק:
# סקירה שבועית - [שם המדד] | דני כהן
...
חוקי הפורמט:
- הקפד על האיות "דני כהן" ולא "דני כוהן" לכל אורך הטקסט ובכותרת
- אל תשתמש בפורמט מעל אלא תבחר משהו אותנטי וסובייקטיבי
- שים לב שהתעלות בציור לא תמיד מעודכנות לשבוע האחרון והן ישנות
- השתמש בשפה חדה וישירה, והעדף רשימות ממוקדות על פני פסקאות תיאוריות ארוכות
"""
